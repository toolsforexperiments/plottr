...
This implementation has been contributed to QCoDeS. When a QCoDeS version that
exposes ``qcodes.dataset.get_db_overview`` is installed, that implementation is
used; otherwise the equivalent local implementation below (kept as an exact
copy of the upstream version) is used as a fallback.
"""
